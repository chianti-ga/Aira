...
impl ToString for PropsData {
    fn to_string(&self) -> String {
        return String::from(format!("modelname:{}\n\
        bodygroup:{}\n\
        surfaceprop:{}\n\
        contents:{}\n\
        cdmaterials:{}\n\
        cbox:{:?}\n\
        collisionmodel{}", self.modelname, self.bodygroup, self.surfaceprop, self.contents, self.cdmaterials, self.cbox, self.collisionmodel));
    }
}
